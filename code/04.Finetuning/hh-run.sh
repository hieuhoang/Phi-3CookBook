...
#export HF_HOME=/mnt/eastus/hieu/workspace/cache/huggingface
# python hh-train-parallel.py --language_pairs af-en --output_dir ./phi-3-medium-LoRA-af-en --model_id microsoft/Phi-3-medium-4k-instruct
...
# # SIZE PROB
# NAME=medium.gp1.size-prob && singsub --name $NAME --gpu G16 --vc lang-sing-wu3 \
#     --venv /opt/envs/hihoan/phi.amd/bin/activate python \
#     hh-train-parallel.py --output_dir $NAME --model_id microsoft/Phi-3-medium-4k-instruct --save_steps 5000 \
#     --language_pairs en-da,en-nl,en-de,en-is,en-no,en-sv,en-af \
#     --nllb_interleave_probs "0.1313,0.2043,0.2748,0.0897,0.0927,0.1675,0.0397"

# MINI
LLM=microsoft/Phi-3-mini-4k-instruct
LLM_NAME=mini

NAME=$LLM_NAME.gp1 && singsub --name $NAME --gpu G16 --vc lang-sing-wu3 \
    --venv /opt/envs/hihoan/phi.amd/bin/activate python \
    hh-train-parallel.py --output_dir $NAME --model_id $LLM --save_steps 5000 \
    --language_pairs en-da,en-nl,en-de,en-is,en-no,en-sv,en-af 

NAME=$LLM_NAME.gp1.size-prob && singsub --name $NAME --gpu G16 --vc lang-sing-wu3 \
    --venv /opt/envs/hihoan/phi.amd/bin/activate python \
    hh-train-parallel.py --output_dir $NAME --model_id $LLM --save_steps 5000 \
    --language_pairs en-da,en-nl,en-de,en-is,en-no,en-sv,en-af \
    --nllb_interleave_probs "0.1313,0.2043,0.2748,0.0897,0.0927,0.1675,0.0397"
