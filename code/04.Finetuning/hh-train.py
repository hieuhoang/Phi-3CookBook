...
def format_dataset_chatml(row):
    ...
    ret = {"text": tokenizer.apply_chat_template(row["messages"], add_generation_prompt=False, tokenize=False)}
    return ret
...
dataset_chatml = dataset_chatml.remove_columns(["instruction", "input", "output", "prompt", "messages"])
